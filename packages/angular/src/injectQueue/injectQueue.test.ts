...
describe("injectQueue", () => {
  ...
  describe("Basic Functionality", () => {
    it("returns trigger, tasks, stats, abort, retry, remove, removeSettled, clear, setConcurrency", () => {
      ...
      expect(result).toHaveProperty("removeSettled");
      expect(result).toHaveProperty("clear");
      expect(result).toHaveProperty("setConcurrency");
    });
  ...
  describe("RemoveSettled", () => {
    it("removeSettled removes all finished tasks", async () => {
      const { injectQueue, setDelay } = createTestHooks();
