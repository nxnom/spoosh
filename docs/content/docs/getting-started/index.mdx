...
This guide will help you set up Spoosh in your React project and make your first type-safe API call.
...
```bash
npm install @spoosh/core @spoosh/react @spoosh/plugin-cache @spoosh/plugin-invalidation
```
...
> **Why invalidationPlugin?** When you create, update, or delete data with `useWrite`, the invalidation plugin automatically refreshes related queries. No manual cache management needed.
