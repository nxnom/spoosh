...
- **Server Adapters** - First-class support for Hono and Elysia with automatic type inference
- **Cache Invalidation** - Automatic tag-based cache invalidation after mutations
- **OpenAPI Conversion** - Bidirectional conversion between TypeScript and OpenAPI 3.0/3.1 specs
