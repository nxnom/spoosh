...
<Callout type="info">
For proper type inference, your Hono routes must follow the [Hono RPC guide](https://hono.dev/docs/guides/rpc). Chain your routes directly on the app instance and export the app type.
</Callout>
