...
Using [Hono](/docs/react/type-adapters/hono) or [Elysia](/docs/react/type-adapters/elysia)? You can infer the schema directly from your server routes for end-to-end type safety with zero manual definitions.
...
Browse the full list of available plugins on the [Plugins](/docs/react/plugins) page.
...
<Cards>
  ...
  <Card title="Hooks" href="/docs/react/hooks" />
</Cards>
