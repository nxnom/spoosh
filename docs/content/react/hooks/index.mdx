...
await trigger({
  ...
  invalidate: (api) => [
    ...
    api("users/:id/stats").GET, // invalidates "users/{userId}/stats"
  ],
});
```
...
- [useRead](/react/docs/hooks/use-read) - Fetch data with automatic caching
- [useWrite](/react/docs/hooks/use-write) - Trigger mutations with loading states
- [useInfiniteRead](/react/docs/hooks/use-infinite-read) - Paginated data fetching
