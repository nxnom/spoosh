...
Unlike `middleware`, `afterResponse` runs after every response — even when other plugins return early from cache. See [Middleware](/docs/react/plugin-development/middleware) for more details.
