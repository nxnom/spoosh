...
The Transform plugin enables per-request transformation of query, body, and response data. All transforms are defined at the hook level for full type inference.
