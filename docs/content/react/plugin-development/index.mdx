...
For plugins with options, use the `createSpooshPlugin` helper for automatic type inference. See the [Type Safety](/docs/react/plugin-development/advanced/type-safety) guide for details.
