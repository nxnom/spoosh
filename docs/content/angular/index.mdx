...
Using [Hono](/docs/angular/integrations/hono) or [Elysia](/docs/angular/integrations/elysia)? You can infer the schema directly from your server routes for end-to-end type safety with zero manual definitions.
