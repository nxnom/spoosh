...
For plugins with options, use the `createSpooshPlugin` helper for automatic type inference. See the [Type Safety](/docs/angular/plugin-development/advanced/type-safety) guide for details.
...
- **[Patterns](/docs/angular/plugin-development/advanced/patterns)** - Middleware patterns, retry logic, caching strategies
- **[After Response](/docs/angular/plugin-development/advanced/after-response)** - Side effects and transformations that always run
- **[Meta Storage](/docs/angular/plugin-development/advanced/meta-storage)** - Storing user-facing data for hook results
- **[Plugin Communication](/docs/angular/plugin-development/advanced/plugin-communication)** - How plugins share data and coordinate
- **[Tracing](/docs/angular/plugin-development/advanced/tracing)** - Emit trace events for devtool visibility
- **[Lifecycle](/docs/angular/plugin-development/advanced/lifecycle)** - Managing state, tracking instances, cleanup
- **[Architecture](/docs/angular/plugin-development/advanced/architecture)** - How plugins work internally, execution order, PluginContext
- **[Type Safety](/docs/angular/plugin-development/advanced/type-safety)** - Making your plugins type-safe with TypeScript
- **[Instance APIs](/docs/angular/plugin-development/advanced/instance-api)** - Extending the Spoosh instance with custom methods (advanced)
- **[Testing](/docs/angular/plugin-development/advanced/testing)** - Unit tests, integration tests, test utilities

Check out the [official plugins](/docs/angular/plugins) for real-world examples.
