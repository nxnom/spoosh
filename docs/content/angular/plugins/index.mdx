...
| ---------------------------------------------------- | ------------------------------ | --------------------------------------------- |
| [Cache](/angular/docs/plugins/cache)                 | `@spoosh/plugin-cache`         | Response caching with configurable stale time |
| [Invalidation](/angular/docs/plugins/invalidation)   | `@spoosh/plugin-invalidation`  | Auto-invalidate queries after mutations       |
| [Deduplication](/angular/docs/plugins/deduplication) | `@spoosh/plugin-deduplication` | Prevent duplicate concurrent requests         |
| [Retry](/angular/docs/plugins/retry)                 | `@spoosh/plugin-retry`         | Automatic retry on failure                    |

### Data Management

| Plugin                                             | Package                       | Description                                |
| -------------------------------------------------- | ----------------------------- | ------------------------------------------ |
| [Optimistic](/angular/docs/plugins/optimistic)     | `@spoosh/plugin-optimistic`   | Instant UI updates with automatic rollback |
| [Initial Data](/angular/docs/plugins/initial-data) | `@spoosh/plugin-initial-data` | Provide initial data for queries           |
| [Prefetch](/angular/docs/plugins/prefetch)         | `@spoosh/plugin-prefetch`     | Preload data before it's needed            |

### Request Control

| Plugin                                     | Package                   | Description                               |
| ------------------------------------------ | ------------------------- | ----------------------------------------- |
| [Polling](/angular/docs/plugins/polling)   | `@spoosh/plugin-polling`  | Automatic periodic refetching             |
| [Refetch](/angular/docs/plugins/refetch)   | `@spoosh/plugin-refetch`  | Refetch on window focus/network reconnect |
| [Debounce](/angular/docs/plugins/debounce) | `@spoosh/plugin-debounce` | Delay requests until input stops changing |
| [Throttle](/angular/docs/plugins/throttle) | `@spoosh/plugin-throttle` | Limit request frequency                   |

### Data Transformation

| Plugin                                       | Package                    | Description                                  |
| -------------------------------------------- | -------------------------- | -------------------------------------------- |
| [Path Case](/angular/docs/plugins/path-case) | `@spoosh/plugin-path-case` | Write camelCase, send kebab-case to API      |
| [QS](/angular/docs/plugins/qs)               | `@spoosh/plugin-qs`        | Nested object serialization for query params |
| [Transform](/angular/docs/plugins/transform) | `@spoosh/plugin-transform` | Transform request and response data          |

### Development

| Plugin                               | Package                | Description         |
| ------------------------------------ | ---------------------- | ------------------- |
| [Debug](/angular/docs/plugins/debug) | `@spoosh/plugin-debug` | Development logging |
