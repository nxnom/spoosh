...
When your body contains `File` or `Blob` objects, they are automatically detected and sent as FormData:
...
| Path with `/:param` | Dynamic path segment       | `"users/:id": \{ GET: \{ data: User \} \}`           |
